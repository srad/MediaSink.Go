...
import (
	...
	"github.com/srad/mediasink/ent/migrate"
	...
	"github.com/srad/mediasink/ent/user"
)
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.Channel, c.Command, c.Job, c.Recording, c.Setting, c.User,
	} {
		n.Use(hooks...)
	}
}
...
// QueryRecordings queries the recordings edge of a Channel.
func (c *ChannelClient) QueryRecordings(ch *Channel) *RecordingQuery {
...
// QueryJobs queries the jobs edge of a Channel.
func (c *ChannelClient) QueryJobs(ch *Channel) *JobQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *RecordingClient) UpdateOne(r *Recording) *RecordingUpdateOne {
	mutation := newRecordingMutation(c.config, OpUpdateOne, withRecording(r))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *RecordingClient) DeleteOne(r *Recording) *RecordingDeleteOne {
...
type (
	hooks struct {
		Channel, Command, Job, Recording, Setting, User []ent.Hook
	}
	inters struct {
		Channel, Command, Job, Recording, Setting, User []ent.Interceptor
	}
)
